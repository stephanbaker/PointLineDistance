function main() {
    ...
    for(var i=0;i<points.length; i++) {
        ...
        var point = points[i]
        var sphereGeometry = new THREE.SphereGeometry( 0.2, 20, 20, 0, Math.PI * 2, 0, Math.PI * 2)
    ...
    function render() {
        ...
        cameraRotation += 1
        rotateCamera(camera, cameraRotation)
...
function rotateCamera(camera, degrees) {
    ...
    camera.position.x = Math.sin(rotation) * 20.0
    camera.position.z = Math.cos(rotation) * 20.0
